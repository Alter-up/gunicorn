...
REDIRECT_URL = "https://tough-lingerie-bear.cyclic.app/claim"  # Your Oauth redirect URI
...
def claim():
    ...
    return render_template("claim.html", user=user, guilds=guilds, connections=connections)
